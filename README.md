...
flowchart TD
    ...
    subgraph Phase_7 ["7. Usage & Portfolio Management Phase (Active Lifecycle)"]
        direction TB
        Q["Active Card Usage & Ongoing Revenue Generation<br/><br/><b>Revenue Calculation:</b><br/>Interchange Revenue = Purchase volume x interchange rate<br/><br/>Interest Income (NIM) = Avg. Outstanding Balance X NIM Rate<br/><br/>Fee Income<br/><br/>Total Revenue = Interchange Revenue + Interest Income + Fee Income<br/><br/><b>Profitability Calculation:</b><br/>Cost = Cost of Funds (CoF) + Rewards & Loyalty Expense + operational costs<br/><br/>Profit = Total Revenue - Costs"]
